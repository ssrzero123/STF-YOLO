...
def get_params():
    params = {
        'weight': 'runs/detect/final/weights/last.pt',
        'cfg': 'cfg/models/v8/final.yaml',
        'device': 'cuda:0',
...
if __name__ == '__main__':
    ...
    # model(r'cfg/datasets/images/new138a.jpg', 'result')
    model(r'cfg/datasets/images/origin.jpg', 'result2')